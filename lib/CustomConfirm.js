  ...
  _createClass(CustomConfirm, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_Dialog["default"], {
        ...
        _: title
      }, translateOptions))), _react["default"].createElement(_DialogContent["default"], null, _react["default"].createElement(CustomConfirmContent, this.props)), _react["default"].createElement(_DialogActions["default"], null, _react["default"].createElement(_reactAdmin.Button, {
        label: cancel,
        disabled: loading,
        onClick: onClose
      }, _react["default"].createElement(CancelIcon, {
        className: classes.iconPaddingStyle
      })), _react["default"].createElement(_reactAdmin.Button, {
        label: confirm,
        disabled: loading,
